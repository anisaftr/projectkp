            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    ...
                    <ul class="navbar-nav text-center ml-auto">
                        <li class="nav-item">
                            <a class="nav-link ml-3 text-white" href="{{ route('pekat.laporan') }}">Peminjaman</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link ml-3 text-white" href="{{ route('pekat.logout') }}"
                                style="text-decoration: underline">{{ Auth::guard('pengguna')->user()->nama }}</a>
                        </li>
                    </ul>
                    @else
                    <ul class="navbar-nav text-center ml-auto">
    ...
    <div class="row justify-content-between">
        <div class="col-lg-8 col-md-12 col-sm-12 col-12 col">
            <div class="content content-top shadow">
                ...
                @endforeach
                @endif
                @if (Session::has('peminjaman'))
                <div class="alert alert-{{ Session::get('type') }}">{{ Session::get('peminjaman') }}</div>
                @endif
            ...
            <div class="content content-bottom shadow">
                <div>
                    ...
                    <div class="self-align">
                        <h5><a style="color: #6a70fc" href="#">{{ Auth::guard('pengguna')->user()->nama }}</a></h5>
                        <p class="text-dark">{{ Auth::guard('pengguna')->user()->username }}</p>
                    </div>
